...
| `medical_officer`             | string        | No                                                       | max:255, letters/spaces/hyphens/apostrophes/periods only | Letters, spaces, hyphens, apostrophes, periods                                | Name of medical officer (only letters and common name characters)                   |
...
| `treatment_name`       | string | ✅ Yes   | max:255, letters/spaces/hyphens/apostrophes/periods only | Letters, spaces, hyphens, apostrophes, periods | Specific name of treatment (only letters and common name characters) |
...
| `treatment_name`       | string  | ✅ Yes                | Specific name of treatment             | Max 255 characters, letters/spaces/hyphens/apostrophes/periods only                                                                                                                                                                |
