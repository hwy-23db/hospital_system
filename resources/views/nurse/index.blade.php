                ...
                <tr class="border-b hover:bg-blue-50/50 transition">
                    ...
                    <td class="py-4 px-4 font-semibold">
                        ...
                        <div class="text-xs text-gray-500">
                            ID: PT{{ str_pad($nurse->id, 4, '0', STR_PAD_LEFT) }}
                        </div>
                    </td>

                     <td class="py-4 px-4">{{ $nurse->nrc_number }}</td>

                    <td class="py-4 px-4">{{ $nurse->email }}</td>

                    <td class="py-4 px-4">{{ $nurse->department }}</td>


                    <td class="py-4 px-4 flex gap-2">
                        @if(auth()->user()->role === 'admin')
                        <a href="{{ route('nurse.edit', $nurse->id) }}"
